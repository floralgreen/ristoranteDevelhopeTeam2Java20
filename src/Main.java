public class Main {
    ...
    public static void main(String[] args) {
        ...
        PrimoPiatto primoPiatto5 = new PrimoPiatto(TipoPortataEnum.PRIMOPIATTO,CurrencyEnum.EURO,"Ravioli alla gricia",8.00,"Farina,Sale,Olio,Pecorino romano,Parmiggiano, Pepe");

        SecondoPiatto secondoPiatto1 = new SecondoPiatto(TipoPortataEnum.SECONDOPIATTO,CurrencyEnum.EURO,"Salti in bocca alla romana", 8.50, "Fettine di vittella,salvia,vino bianco,farina 00,prosciutto crudo,burro,pepe,olio");
        ...
        Dolce dolci3 = new Dolce(TipoPortataEnum.DOLCE,CurrencyEnum.EURO,"Sorbetto al limone", 3.0, "Zucchero,Limoncello,succo di limone,albumi");
        Dolce dolci4 = new Dolce(TipoPortataEnum.DOLCE,CurrencyEnum.EURO,"Crostata con marmellata di visciole", 3.50, "Farina,burro,sale,zucchero a velo,scorza di limone,tuorli,visciole,confettura di ciligie,zucchero di canna");
        Dolce dolci5 = new Dolce(TipoPortataEnum.DOLCE,CurrencyEnum.EURO,"Sbriciolata", 4.0, "Farina,Uova,burro,zucchero,lievito,bacca di vaniglia,Nutella/Crema");

        Bevanda bevanda1 = new Bevanda(TipoPortataEnum.BEVANDA,CurrencyEnum.EURO, "Acqua Naturale", 2.00, "Brocca da 1L");
        Bevanda bevanda2 = new Bevanda(TipoPortataEnum.BEVANDA,CurrencyEnum.EURO, "Acqua Minerale", 2.00, "Brocca da 1L");
        Bevanda bevanda3 = new Bevanda(TipoPortataEnum.BEVANDA,CurrencyEnum.EURO, "Vino Rosso", 5.00, "Vino della casa, 1L");
        Bevanda bevanda4 = new Bevanda(TipoPortataEnum.BEVANDA,CurrencyEnum.EURO, "Vino Bianco", 5.00, "Vino della casa, 1L");
        Bevanda bevanda5 = new Bevanda(TipoPortataEnum.BEVANDA,CurrencyEnum.EURO, "Coca Cola", 3.00, "lattina da 33cl");

        Antipasto antipasto1 = new Antipasto(TipoPortataEnum.ANTIPASTO,CurrencyEnum.EURO, "Tagliere di salumi", 8.00, "Salame, Prosciutto Crudo, Prosciutto Cotto, Lonza, Speck, Spianata");
        Antipasto antipasto2 = new Antipasto(TipoPortataEnum.ANTIPASTO,CurrencyEnum.EURO, "Tagliere di formaggi", 9.00, "Asiago DOP, Parmiggiano Reggiano DOP, Provola, Scamorza affumicata");
        Antipasto antipasto3 = new Antipasto(TipoPortataEnum.ANTIPASTO,CurrencyEnum.EURO, "Tris di bruschette", 5.00, "Bruschetta al pomodoro, Bruschetta alle olive, Bruschetta con olio della casa");
        Antipasto antipasto4 = new Antipasto(TipoPortataEnum.ANTIPASTO,CurrencyEnum.EURO, "Pizzella con prosciutto crudo", 6.00, "Prosciutto crudo, acqua, sale, olio, farina");
        Antipasto antipasto5 = new Antipasto(TipoPortataEnum.ANTIPASTO,CurrencyEnum.EURO, "Mozzarella in carrozza", 4.00, "Mozzarella, pan grattato, uovo, sale");
