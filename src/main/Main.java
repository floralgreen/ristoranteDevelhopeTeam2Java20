...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            //istanzio Clienti
            Customer federico = new Customer(TipoMenuEnum.NONPREFERENCE, "Federico", "Carducci", 23, GenderEnum.MALE);
            ...
            caffeineCoders.printMenuCustomer(federico);
            System.out.println("\n");
